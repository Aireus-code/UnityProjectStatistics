...
public static class ProjectStatsData
{
    ...
    public static readonly string KeyEditor                = Application.dataPath + "_editorTime";
    public static readonly string KeyPlay                  = Application.dataPath + "_playTime";
    public static readonly string KeyUnfocused             = Application.dataPath + "_unfocusedTime";
    public static readonly string KeySessions              = Application.dataPath + "_totalSessions";
    public static readonly string KeySessionID             = Application.dataPath + "_sessionID";
    public static readonly string KeySessionStartEditor    = Application.dataPath + "_sessionStartEditor";
